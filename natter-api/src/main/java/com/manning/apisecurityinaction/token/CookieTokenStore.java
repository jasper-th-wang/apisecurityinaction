...
public class CookieTokenStore implements TokenStore {
    ...
    public String create(Request request, Token token) {
        ...
        // THIS FIXES THE FIXATION VULNERABILITY
        // This invalidate existing session
        ...
        // now return the SHA-256 hash of the session cookie instead
    ...
    public Optional<Token> read(Request request, String tokenId) {
        ...
        // decode supplied token ID
        var provided = Base64url.decode(tokenId);
        var computed = sha256(session.id());
        // compared it to the hash of the session
        // // if not matching, reject the request
